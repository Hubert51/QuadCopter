...
Point2f optical_flow(Mat &I1, Mat &I2) { 
    ...
    x_shift /= features_after.size();
    y_shift /= features_after.size();
    cout << "x_shift " << x_shift << " " << "y_shift " << y_shift << endl;
    return Point2f(x_shift, y_shift);
